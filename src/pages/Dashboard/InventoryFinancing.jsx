        ...
        <div className="_sideM_head">
          ...
          <nav className="_amazWeb_servBox">
            <div className="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              {/* <button class="nav-link" id="talabatHome_s1-tab" data-bs-toggle="tab"
                                      data-bs-target="#talabatHome_s1" type="button" role="tab" aria-controls="talabatHome_s1"
                                      aria-selected="false">
                                      <span class="IcoFle_tab"><img src="image/talabat_minIcon.png" alt=""><span
                                              class="">Talabat</span></span>
                                  </button>
  
                                  <button class="nav-link" id="jaheezHome_s1-tab" data-bs-toggle="tab"
                                      data-bs-target="#jaheezHome_s1" type="button" role="tab" aria-controls="jaheezHome_s1"
                                      aria-selected="false">
                                      <span class="IcoFle_tab"><img src="image/jaheez_minIcon.png" alt=""><span
                                              class="">Jahez</span></span>
                                  </button> */}
            </div>
          </nav>
          <div className="tab-content grapContent" id="nav-tabContent">
            ...
            {/* <div class="tab-pane fade" id="talabatHome_s1" role="tabpanel"
                                  aria-labelledby="talabatHome_s1-tab" tabindex="0">
                                  <div class="container-fluid">
                                      <div class="row _graphRow">
  
                                          <div class="_dynCol">
                                              <div class="circGraphBox">
  
                                                  <div class="inerCirc_graph">
                                                      <img src="image/Ring_Chart5.png" alt="">
                                                      <div class="circGraph_percent">
                                                          <p>16.67 %</p>
                                                      </div>
                                                  </div>
  
                                                  <div class="rp_limitsBox">
                                                      <div class="_rpLimit top_rpLimit">60,000 AED <span>Available
                                                              Limit</span></div>
                                                      <div class="_rpLimit mid_rpLimit">10,000 AED <span>Used</span></div>
                                                      <div class="_rpLimit bot_rpLimit">50,000 AED <span>Balance</span>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="_dynCol">
                                              <div class="recevaBle_box  _sRecive">
                                                  <div class="_recv_firstP">
                                                      <div>
                                                          <img src="image/Ring_Chart1.png" alt="">
                                                      </div>
  
                                                      <div class="recv_netPra">
                                                          <p>Net Seller Receivables</p>
                                                          <h6>82,000 AED</h6>
                                                      </div>
                                                  </div>
                                                  <div class="recP_devider"></div>
                                                  <div class="_recv_firstP">
                                                      <div>
                                                          <img src="image/Ring_Chart1.png" alt="">
                                                      </div>
                                          ...
                                          <div class="_dynCol">
                                              <div class="recevaBle_box _lRecive">
                                                  <div class="_recv_firstP">
                                                      <div>
                                                          <img src="image/Ring_Chart1.png" alt="">
                                                      </div>
                                          ...
                                          <div class="_dynCol">
                                              <div class="recevaBle_box _mRecive">
                                                  <div class="_recv_firstP">
                                                      <div class="recv_netPra">
                                                          <p>Total  Installments</p>
                                                      </div>
                                          ...
                                          <div class="_dynCol">
                                              <div class="nxtPay_dateBox">
  
                                                  <div class="nxtpPar">
                                                      <p>Next Payment Date</p>
                                                  </div>
  
                                                  <div class="nxtp_inDate">
                                                      <h4>15th Dec</h4>
                                                  </div>
                                              </div>
                                          </div>
                                          <div>
                                              <div class="row _graphRow">
                                                  ...
                                                  <div class="_dynFull_col">
                                                      <div class="row">
  
                                                          <div id="myChart_s3" class="chart--container">
                                                              <a href="https://www.zingchart.com/" rel="noopener"
                                                                  class="zc-ref">Powered by ZingChart</a>
                                                          </div>
                              ...
                              <div class="tab-pane fade" id="jaheezHome_s1" role="tabpanel" aria-labelledby="jaheezHome_s1-tab"
                                  tabindex="0">
                                  <div class="container-fluid">
                                      <div class="row _graphRow">
                                              ...
                                              <div class="row _graphRow">
                                                  ...
                                                  <div class="_dynFull_col">
                                                      <div class="row">
                                                          ...
                                                          <div id="myChart_s4" class="chart--container">
                                                              <a href="https://www.zingchart.com/" rel="noopener"
                                                                  class="zc-ref">Powered by ZingChart</a>
                                                          </div>
